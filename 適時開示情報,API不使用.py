...
connection = MySQLdb.connect(
    host='localhost', user='root', passwd='Baba1231', db='tdnet_db', charset='utf8')
...
WEB_HOOK_URL = "https://hooks.slack.com/services/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"
